...
const TOKEN = "aa972210b0ff560ffafe94a4dbe15515093992e85aa1aa8ba784feb83af2915c" // ADD YOUR IMMERSAL DEVELOPER TOKEN
const MAP_IDS = [
  { id: 77952 },  // ADD YOUR IMMERSAL MAP ID
]
...
/*
    ...
    loader.load(
        ...
        (gltf) => {
          ...
          console.log(testModel.position)
          console.log(testModel.scale)
  ...
  $.ajax({
    ...
    success: function(data)
    {
      if (data.success) {
        ...
        try{
          document.getElementById('localizebutton').style.color = 'green';
        } catch (e){}
        if (false) {
        ...
        if(testModel){
          try {
            ...
            testModel.position.set(position.x, position.y + 18.440, position.z + 43.562);
            testModel.quaternion.set(rotation.x, rotation.y, rotation.z, rotation.w);
            //testModel.scale.set(scale.x, scale.y, scale.z);
            testModel.scale.set(3.0, 3.0, 3.0);
        ...
        try{
          document.getElementById('localizebutton').style.color = 'red';
        } catch (e){}
      }
      isLocalizing = false
    }
