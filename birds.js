...
const createBird = asset => {
    const gltf = asset
    const mesh = THREE.SkeletonUtils.clone(gltf.scene)
...
const createSystemBirds = (container) => {
    const birds = []
    let places = []
    let paths = []
...
window.startBirds = (container) => {
    const loader = new THREE.GLTFLoader()
    loader.load('./testa4.glb', model => {
        const systemBirds = createSystemBirds(container)
